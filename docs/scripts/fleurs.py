...
reference is measured alongside it.
    ...
    python docs/scripts/fleurs.py <n_samples> <build> [build ...]
"""
...
print(f"# FLEURS de_de test, first {N} recordings", flush=True)
...
print(f"# {len(clips)} recordings, {total_sec/60:.1f} min of audio\n")
