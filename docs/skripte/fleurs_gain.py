...
The hand-corrected podcast reference is 422 words -- section 9 of
docs/voxtral-audio-vorverarbeitung.md shows its bootstrap interval is far too
...
let one clip and give the other the headroom, and compare.
    ...
    python docs/skripte/fleurs_gain.py <n_samples> <build> <gain_db> [gain_db ...]
    python docs/skripte/fleurs_gain.py 150 models/voxtral-mini-8bit 0 -12 -24
    python docs/skripte/fleurs_gain.py 150 models/voxtral-mini-8bit 5.3c 2.3c
"""
import io
import json
import pathlib
...
def main():
    ...
    if len(GAINS) > 1:
        print("\nGepaarte Differenzen ueber Aufnahmen "
