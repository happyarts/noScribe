...
(see docs/voxtral-audio-vorverarbeitung.md, section 9), and FLEURS is natively
...
Arms:
  ...
  soxr-flt   soxr VHQ, no integer stage at all       (isolates the bit depth)
    ...
    python docs/skripte/fleurs_resample.py <n_samples> <build> [arm ...]
"""
import json
import pathlib
import sys
...
def main():
    ...
    print(f"# 16k -> {UP} (soxr VHQ, allen Armen gemeinsam) -> 16k auf dem jeweiligen Weg")
    print(f"# Build: {build}\n")
