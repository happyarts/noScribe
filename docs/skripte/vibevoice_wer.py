...
the *identical* normalisation and edit distance as docs/skripte/wer.py, plus the
things only this model can be asked -- how many speakers it found, and whether
it punctuates.

    python docs/skripte/vibevoice_wer.py ref <reference.txt> <audio.wav> [arm]
    python docs/skripte/vibevoice_wer.py fleurs <n_samples> [arm]
