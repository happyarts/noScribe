...
`voxtral-mel-clamp-floor.md`, sections 2-3 and 8.)
...
| small-8bit | refused — ~28 GB peak for its shortest pass, plus 6 GB headroom |
...
- Most of the hard-audio side of this document rests on one 422-word,
  ...
  `other-asr-engines.md`). The build sweeps above have not been repeated
